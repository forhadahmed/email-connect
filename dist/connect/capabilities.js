...
export function normalizeScopeSet(scopes) {
 ...
 */
export function defaultScopesForCapabilityMode(provider, capabilityMode = 'send') {
    if (provider === 'gmail') {
 ...
 */
export function requiredScopeAlternativesForOperation(provider, operation) {
...
export function isOperationAuthorized(provider, scopes, operation) {
...
export function deriveMailboxCapabilities(provider, scopes) {
    const granted = scopeSet(scopes);
    if (provider === 'gmail') {
        return {
