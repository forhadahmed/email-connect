...
export type ConnectTokenFailureMode = 'invalid_client' | 'invalid_grant' | 'invalid_scope' | 'temporarily_unavailable';
...
export type MailboxBackendConfig = GmailBackendConfig & GraphBackendConfig & {
...
export type MessageAddressLike = string | string[] | null | undefined;
