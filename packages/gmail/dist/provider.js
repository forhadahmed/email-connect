...
function gmailUserInfo(mailbox) {
    return {
    ...
    connect: {
        ...
        shouldIssueRefreshToken(params) {
            if (params.accessType !== 'offline')
                return false;
            if (!params.mailbox.auth.offlineGrantIssued)
                return true;
    ...
    http: {
        async handle(context) {
            ...
            if (method === 'GET' && pathname === '/gmail/v1/users/me/messages') {
                ...
                context.sendJson(200, await service.listMessages(mailbox.id, {
            ...
            if (method === 'GET' && pathname === '/gmail/v1/users/me/history') {
                ...
                context.sendJson(200, await service.listHistory(mailbox.id, {
